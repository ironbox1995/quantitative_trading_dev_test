...
raw_fin_cols = ['短期借款', '长期借款', '应付债券', '一年内到期的非流动负债', '营业收入', '营业总收入', '负债应付利息', '应付手续费及佣金', '销售费用', '管理费用', '研发费用', '资产减值损失',
                '固定资产折旧、油气资产折耗、生产性物资折旧', '无形资产摊销', '长期待摊费用摊销', '其他综合利益', '税金及附加', '营业成本', '归母净利润', '归母所有者权益合计', '货币资金',
                '流动负债合计', '非流动负债合计', '经营活动产生的现金流量净额', '净利润', '营业总成本', '应收票据及应收账款', '现金及现金等价物净增加额', '投资活动产生的现金流量净额']
flow_fin_cols = ['归母净利润', '净利润', '营业收入', '营业总收入', '营业总成本', '经营活动产生的现金流量净额', '研发费用']
derived_fin_cols = ['归母净利润_ttm', '归母净利润_ttm同比', '归母净利润_单季', '归母净利润_单季同比', '营业收入_ttm', '营业收入_单季同比', '营业收入_单季环比', '研发费用_ttm', '净利润_单季', '净利润_ttm', '净利润_ttm同比', '营业总收入_ttm', '营业总成本_ttm', '营业总收入_单季', '营业总收入_单季同比', '营业总收入_单季环比', '经营活动产生的现金流量净额_ttm']
cross_fin_cols = []
