...
strategy_stop_loss_point_dct = {"{}_{}_选{}_{}".format("小市值策略", period_type, select_stock_num, "无择时"): -0.3,
                                "{}_{}_选{}_{}".format("小市值策略_分箱优化1", period_type, select_stock_num, "WMA择时"): -0.25}
